...
-- Dữ liệu mẫu
INSERT INTO classes (ma_lop, ten_mon, hoc_ky, nam_hoc, so_tin_chi) 
VALUES ('LOP001', 'Toán Cao Cấp', 1, 2025, 3),
       ('LOP002', 'Lập trình C', 1, 2025, 2);

INSERT INTO students (ma_sv, ten_sv, class_id) 
VALUES ('SV001', 'Nguyễn Văn A', 1),
       ('SV002', 'Trần Thị B', 1),
       ('SV003', 'Lê Văn C', 2);

INSERT INTO scores (student_id, diem_chuyen_can, diem_giua_ky_1, diem_giua_ky_2, diem_thao_luan, diem_cuoi_ky) 
